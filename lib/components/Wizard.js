  ...
  function Wizard() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Wizard.__proto__ || Object.getPrototypeOf(Wizard)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _this.setState({ steps: steps }, function () {
        ...
        var canNavigate = step.canNavigateTo || function () {
          return true;
        };
        if (step.id !== null && canNavigate(_this.getChildContext().wizard)) {
  ...
  _createClass(Wizard, [{
    ...
    value: function componentWillMount() {
      ...
      this.unlisten = this.history.listen(function (_ref2) {
        ...
        var currentStep = _this2.state.step;
        var targetStep = _this2.pathToStep(pathname);
        var canNavigate = targetStep.canNavigateTo || function () {
          return true;
        };
        if (currentStep.id === null || currentStep.id !== null && canNavigate(_this2.getChildContext().wizard)) {
          _this2.setState({ step: targetStep });
        }
      });
